...
╎✰ۣۜۜ͜͡🦊 Bem-vindo!(a)
╎✰ۣۜۜ͜͡💜 @${xeonName.split("@")[0]}
╎✰ۣۜۜ͜͡🌸 ${metadata.subject}
╎✰ۣۜۜ͜͡⚙️ ${xdate}
╎✰ۣۜۜ͜͡⏰️ ${xtime}
╎✰ۣۜۜ͜͡🥂 Divirta-se!
...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
 ...
 if (anu.action == 'promover') {
const xeontime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
const xeondate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let xeonName = num
xeonbody = `═•✧ೋ✧๑🌙๑✧ೋ•═\n\n
𝐏𝐚𝐫𝐚𝐛𝐞𝐧𝐬 @${xeonName.split("@")[0]} 𝐯𝐨𝐜𝐞 𝐟𝐨𝐢 𝐩𝐫𝐨𝐦𝐨𝐯𝐢𝐝𝐨 𝐚 𝐀𝐃𝐌, 𝐞𝐬𝐩𝐞𝐫𝐨 𝐪𝐮𝐞 𝐡𝐨𝐧𝐫𝐞 𝐬𝐞𝐮 𝐜𝐚𝐫𝐠𝐨 <𝟑\n\n
═•✧ೋ✧๑🌙๑✧ೋ•═`
   XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
